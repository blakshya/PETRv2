...
dataset_type = 'AdaptiveNuScenesDataset'
...
train_ann_file = data_root + 'mmdet3d_nuscenes_30f_infos_train.pkl'
val_ann_file = data_root + 'mmdet3d_nuscenes_30f_infos_val.pkl'
test_ann_file = data_root + 'mmdet3d_nuscenes_30f_infos_val.pkl'
...
data = dict(
    ...
    train=dict(
        ...
        box_type_3d='LiDAR'),
    val=dict(type=dataset_type, data_root=data_root, pipeline=test_pipeline, ann_file=val_ann_file, classes=class_names, modality=input_modality),
    test=dict(type=dataset_type, data_root=data_root, pipeline=test_pipeline, ann_file=test_ann_file, classes=class_names, modality=input_modality))
